...
void D2Empty(string Lattice[L][L], int x, int y, int direction, int& chosen, 
		...
		*/
		...
		while (a < spots && b < spots && c < spots)
		{
			...
			else if (Lattice[x][y] == "0")
			{
				...
				D2Empty(Lattice, x, y, direction, a,
					"a", BirthRateA, SwitchRate);
				D2Empty(Lattice, x, y, direction, c,
					"c", BirthRateC, SwitchRate);
				D2Empty(Lattice, x, y, direction, b,
